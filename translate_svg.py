...
# Characters to ignore? This is taken from a text file from Gianni. Not doing anything with this yet.
IGNORED_CHARACTERS = ['-',
                    '.',
                    ',',
                    ';',
...
for file in os.listdir('.'):
    if file.endswith('.svg'):
        ...
        for child in root.iter(r'{http://www.w3.org/2000/svg}text'):
            ...
            else:                                           # If the translation doesn't exist, maintain original word
